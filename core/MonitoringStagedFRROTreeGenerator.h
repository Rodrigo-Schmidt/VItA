...
#ifndef MonitoringStagedFRROTreeGenerator_H_
#define MonitoringStagedFRROTreeGenerator_H_
 ...
 */
class MonitoringStagedFRROTreeGenerator : public IDomainObserver {
	...
	AlternativeAdimSproutingVolumetricCostEstimator *localEstimator;
...
public:
	 ...
	 */
	MonitoringStagedFRROTreeGenerator(StagedDomain *domain, point xi, double rootRadii, double qi, long long int nTerm, vector<AbstractConstraintFunction<double,int> *>gam, vector<AbstractConstraintFunction<double,int> *>epsLim, vector<AbstractConstraintFunction<double,int> *>nu, double refPressure, double viscosityTolerance);
	/**
	 ...
	 * @param nu		Viscosity function.
	 */
	MonitoringStagedFRROTreeGenerator(StagedDomain *domain, AbstractObjectCCOTree *tree, long long int nTerm, vector<AbstractConstraintFunction<double,int> *>gam, vector<AbstractConstraintFunction<double,int> *>epsLim, vector<AbstractConstraintFunction<double,int> *>nu, AlternativeAdimSproutingVolumetricCostEstimator *localEstimator);
	/**
	 * Common destructor.
	 */
	~MonitoringStagedFRROTreeGenerator();
	/**
