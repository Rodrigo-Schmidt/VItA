...
#ifndef TREE_ALTERNATIVEADIMSPROUTINGVOLUMETRICCOSTESTIMATOR_H_
#define TREE_ALTERNATIVEADIMSPROUTINGVOLUMETRICCOSTESTIMATOR_H_
 ...
 * Fick's 2nd law.
 */
class AlternativeAdimSproutingVolumetricCostEstimator: public AbstractCostEstimator {
...
public:
	 ...
	 * Common constructor.
	 */
	AlternativeAdimSproutingVolumetricCostEstimator(double volumeFactor, double proteolyticFactor, double diffusionFactor, double volumeRef, double radiusRef, double lengthRef);
	/**
	 * Common destructor.
	 */
	virtual ~AlternativeAdimSproutingVolumetricCostEstimator();
	/**
	...
	/**
	 * Computes the contribution for this functional.
	 * @param root	Root of the tree at the current step.
	 * @return Vector with the three contributions.
	 */
	vector<double> computeContributionsCost(AbstractObjectCCOTree* tree);
	/**
